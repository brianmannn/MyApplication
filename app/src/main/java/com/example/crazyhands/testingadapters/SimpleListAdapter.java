...
public class SimpleListAdapter extends ArrayAdapter<List_item> {

    private static final String LOG_TAG = SimpleListAdapter.class.getSimpleName();
     ...
     */
    public SimpleListAdapter(Activity context, ArrayList<List_item> allclasses) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        List_item currentListItem = getItem(position);
